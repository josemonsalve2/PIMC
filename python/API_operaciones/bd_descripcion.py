...
class bd_descripcion:
  ...
  def __init__(self):
    ...
    self.insertarIdPrincipalTabla("DocumentosRefEmbarcaciones", "referenciaID")
    ...
    self.insertarDescripcion("DocumentosRefEmbarcaciones", "referenciaID")
    self.insertarDescripcion("DocumentosRefEmbarcaciones", "documentoID")
    self.insertarDescripcion("DocumentosRefEmbarcaciones", "embarcacionID")
    self.insertarDescripcion("DocumentosRefEmbarcaciones", "referencia")
    self.insertarDescripcion("DocumentosRefEmbarcaciones", "comentario")
