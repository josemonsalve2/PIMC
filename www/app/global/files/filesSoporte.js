(function (angular) {
      ...
      var pimcFilesSoporte = angular.module('pimcFilesSoporte',['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'xeditable']);
    
      pimcFilesSoporte.controller('pimcListadoController', ['$scope', 'pimcService', 'pimcBarraEstadoService','$window', function($scope, pimcService, pimcBarraEstadoService, $window) {
      ...
      // COMPONENTS
      pimcFilesSoporte.component('pimcListado', {
        bindings: {
          nombre: '@',
          csvString: '<',
