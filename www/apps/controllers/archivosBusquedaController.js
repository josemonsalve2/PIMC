(function (angular) {
    ...
    angular.module('archivosBusqueda',  ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui.grid', 'ngTouch', 'ui.grid.edit', 'ui.grid.autoResize', 'ui.grid.selection', 'ui.grid.cellNav'])
        .controller('archivosBusquedaController', ['$scope', '$http', '$window', '$location', '$filter', 'uiGridConstants', 'i18nService', '$scope', function ($scope, $http, $window, $location, $filter, i18nService, uiGridConstants) {
            ...
            $scope.abrirArchivosSeleccionados = function () {
                ...
                $window.location.href = "/PIMC/views/archivoPerfil.html";
            };
        }]);
})(window.angular);
